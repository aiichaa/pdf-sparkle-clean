...
- **Phase 2:** ~~Protect / Unlock~~, ~~Compress~~, ~~Fill forms~~, ~~Sign (visual)~~: all done.
- **Maybe later:** certificate-based digital signatures with your own `.p12` certificate, OCR.
